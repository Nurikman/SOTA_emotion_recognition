...
def parse_opts():
    ...
    parser.add_argument('--annotation_path', default='C:/Users/user/Documents/intermediate-fusion/annotations.txt', type=str, help='Annotation file path')
    parser.add_argument('--result_path', default='C:/Users/user/Documents/intermediate-fusion/results', type=str, help='Result directory path')
    ...
    parser.add_argument('--pretrain_path', default='C:/Users/user/Documents/intermediate-fusion/results/EfficientFace_Trained_on_AffectNet7.pth.tar', type=str, help='Pretrained model (.pth), efficientface')
    ...
    parser.add_argument('--model_path', type=str, default="C:/Users/user/Documents/intermediate-fusion/results/fold 5/RAVDESS_multimodalcnn_15_best0.pth",help="Path to saved model files.")
